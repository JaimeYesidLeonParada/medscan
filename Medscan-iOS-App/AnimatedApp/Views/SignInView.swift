...
struct SignInView: View {
    ...
    var body: some View {
        VStack(spacing: 24) {
            ...
            Text("Comparte con otros usuarios tus experiencias de medicamentos, precios, tiendas, y demas información en tiempo real.")
            ...
            Text("Ingresa con Email, Apple, Google")
                .customFont(.subheadline)
                .foregroundColor(.secondary)
